#!/usr/bin/env python3
"""
Flight simulator with DeLand airport terrain, fixed orientation, chase camera.
"""
...
<body>
    ...
    <div class="controls">🖱️ Right‑click for browser menu • Camera follows the plane</div>
    ...
    <script type="module">
        ...
        // --- Ground reference grid (will be below terrain) ---
        ...
        loader.load('{model_path}',
            (gltf) => {{
                ...
                // Fix orientation: rotate so forward is -Z
                airplane.rotation.x = -Math.PI / 2;
                airplane.rotation.z = 0;
                airplane.scale.set(0.5, 0.5, 0.5);
                scene.add(airplane);
                console.log('Aircraft loaded and orientation corrected');
            }},
            undefined,
...
def main():
    ...
    parser.add_argument('-o', '--output', default='flying_game_airport_fixed.html')
