#!/usr/bin/env python3
"""
build_final_gallery_v0018.py

= WORKING v0013 GALLERY + AUTO-SERVER =
- Same working JavaScript as v0013 (images load)
- Automatically starts error server (port 8001)
- Automatically starts HTTP server (port 8000)
...
OUTPUT_HTML = Path("index_v0018.html")
...
def build_html(posts):
    ...
    # v0013 WORKING HTML - DO NOT MODIFY
    html = '<!DOCTYPE html>\n'
    html += '<html lang="en">\n<head>\n'
    html += '<meta charset="UTF-8">\n'
    html += '<meta name="viewport" content="width=device-width, initial-scale=1.0">\n'
    html += '<title>Mr. Douglas Gallery v0018</title>\n'
    html += '<style>\n'
    ...
    html += 'addLog("=== GALLERY v0018 STARTED ===");\n'
...
def main():
    print("=" * 70)
    print("MR. DOUGLAS GALLERY BUILDER v0018")
    print("WORKING v0013 GALLERY + AUTO-SERVER")
    print("=" * 70)
    print()
    ...
    print("   http://localhost:8000/index_v0018.html")
    print()
    print("📊 Status:")
    ...
    threading.Thread(target=open_browser, args=('http://localhost:8000/index_v0018.html',), daemon=True).start()
