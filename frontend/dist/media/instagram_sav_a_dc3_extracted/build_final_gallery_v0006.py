#!/usr/bin/env python3
"""
build_final_gallery_v0006.py

Generates index_v0006.html with:
...
- FIXED: No NameError (all JavaScript variables properly escaped)
...
OUTPUT_HTML = Path("index_v0006.html")
...
# ========== MAIN ==========
def main():
    logger.info("Starting gallery build v0006")
    posts = load_posts()
