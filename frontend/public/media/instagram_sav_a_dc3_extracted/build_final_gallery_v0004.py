#!/usr/bin/env python3
"""
build_final_gallery_v0004_fixed.py

Generates index_v0004.html with:
...
OUTPUT_HTML = Path("index_v0004.html")
...
def build_html(posts):
    ...
    # HTML template – note: the problematic line inside openStoryboardNewTab is now fixed
...
# ========== MAIN ==========
def main():
    logger.info("Starting gallery build v0004")
    posts = load_posts()
